...
| --------- | ------------ | ------------ | ------------ |
| animal-sniffer-annotations | Product | [1.27](https://cloud.google.com/java/docs/reference/animal-sniffer-annotations/latest/overview) | N/A |
| api-common | Runtime | [2.63.0](https://cloud.google.com/java/docs/reference/api-common/latest/overview) | N/A |
| arrow-memory-core | Product | [17.0.0](https://cloud.google.com/java/docs/reference/arrow-memory-core/latest/overview) | N/A |
| arrow-memory-netty | Product | [17.0.0](https://cloud.google.com/java/docs/reference/arrow-memory-netty/latest/overview) | N/A |
| arrow-vector | Product | [17.0.0](https://cloud.google.com/java/docs/reference/arrow-vector/latest/overview) | N/A |
| cel | Product | [0.6.0](https://cloud.google.com/java/docs/reference/cel/latest/overview) | N/A |
| checker-qual | Product | [3.49.0](https://cloud.google.com/java/docs/reference/checker-qual/latest/overview) | N/A |
| commons-codec | Product | [1.18.0](https://cloud.google.com/java/docs/reference/commons-codec/latest/overview) | N/A |
| detector-resources-support | Product | [0.33.0](https://cloud.google.com/java/docs/reference/detector-resources-support/latest/overview) | N/A |
| error_prone_annotations | Product | [2.48.0](https://cloud.google.com/java/docs/reference/error_prone_annotations/latest/overview) | N/A |
| exporter-metrics | Product | [0.33.0](https://cloud.google.com/java/docs/reference/exporter-metrics/latest/overview) | N/A |
| flogger-system-backend | Product | [0.8](https://cloud.google.com/java/docs/reference/flogger-system-backend/latest/overview) | N/A |
...
| google-cloud-bigtable | Product | [2.78.0](https://cloud.google.com/java/docs/reference/google-cloud-bigtable/latest/overview) | [Cloud Bigtable](https://cloud.google.com/bigtable) |
...
| google-cloud-datastore | Product | [2.41.0](https://cloud.google.com/java/docs/reference/google-cloud-datastore/latest/overview) | [Cloud Datastore](https://cloud.google.com/datastore) |
...
| google-extensions | Product | [0.8](https://cloud.google.com/java/docs/reference/google-extensions/latest/overview) | N/A |
...
| httpclient | Product | [4.5.14](https://cloud.google.com/java/docs/reference/httpclient/latest/overview) | N/A |
| httpclient5 | Product | [5.3.1](https://cloud.google.com/java/docs/reference/httpclient5/latest/overview) | N/A |
| httpcore | Product | [4.4.16](https://cloud.google.com/java/docs/reference/httpcore/latest/overview) | N/A |
| httpcore5 | Product | [5.2.5](https://cloud.google.com/java/docs/reference/httpcore5/latest/overview) | N/A |
| j2objc-annotations | Product | [3.1](https://cloud.google.com/java/docs/reference/j2objc-annotations/latest/overview) | N/A |
| jackson-annotations | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-annotations/latest/overview) | N/A |
| jackson-core | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-core/latest/overview) | N/A |
| jackson-databind | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-databind/latest/overview) | N/A |
| jackson-dataformat-avro | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-avro/latest/overview) | N/A |
| jackson-dataformat-cbor | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-cbor/latest/overview) | N/A |
| jackson-dataformat-csv | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-csv/latest/overview) | N/A |
| jackson-dataformat-ion | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-ion/latest/overview) | N/A |
| jackson-dataformat-properties | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-properties/latest/overview) | N/A |
| jackson-dataformat-protobuf | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-protobuf/latest/overview) | N/A |
| jackson-dataformat-smile | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-smile/latest/overview) | N/A |
| jackson-dataformat-toml | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-toml/latest/overview) | N/A |
| jackson-dataformat-xml | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-xml/latest/overview) | N/A |
| jackson-dataformat-yaml | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-dataformat-yaml/latest/overview) | N/A |
| jackson-datatype-eclipse-collections | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-eclipse-collections/latest/overview) | N/A |
| jackson-datatype-guava | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-guava/latest/overview) | N/A |
| jackson-datatype-hibernate4 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-hibernate4/latest/overview) | N/A |
| jackson-datatype-hibernate5 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-hibernate5/latest/overview) | N/A |
| jackson-datatype-hibernate5-jakarta | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-hibernate5-jakarta/latest/overview) | N/A |
| jackson-datatype-hibernate6 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-hibernate6/latest/overview) | N/A |
| jackson-datatype-hppc | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-hppc/latest/overview) | N/A |
| jackson-datatype-jakarta-jsonp | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-jakarta-jsonp/latest/overview) | N/A |
| jackson-datatype-jaxrs | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-jaxrs/latest/overview) | N/A |
| jackson-datatype-jdk8 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-jdk8/latest/overview) | N/A |
| jackson-datatype-joda | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-joda/latest/overview) | N/A |
| jackson-datatype-joda-money | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-joda-money/latest/overview) | N/A |
| jackson-datatype-json-org | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-json-org/latest/overview) | N/A |
| jackson-datatype-jsr310 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-jsr310/latest/overview) | N/A |
| jackson-datatype-jsr353 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-jsr353/latest/overview) | N/A |
| jackson-datatype-pcollections | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-datatype-pcollections/latest/overview) | N/A |
| jackson-jakarta-rs-base | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jakarta-rs-base/latest/overview) | N/A |
| jackson-jakarta-rs-cbor-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jakarta-rs-cbor-provider/latest/overview) | N/A |
| jackson-jakarta-rs-json-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jakarta-rs-json-provider/latest/overview) | N/A |
| jackson-jakarta-rs-smile-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jakarta-rs-smile-provider/latest/overview) | N/A |
| jackson-jakarta-rs-xml-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jakarta-rs-xml-provider/latest/overview) | N/A |
| jackson-jakarta-rs-yaml-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jakarta-rs-yaml-provider/latest/overview) | N/A |
| jackson-jaxrs-base | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jaxrs-base/latest/overview) | N/A |
| jackson-jaxrs-cbor-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jaxrs-cbor-provider/latest/overview) | N/A |
| jackson-jaxrs-json-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jaxrs-json-provider/latest/overview) | N/A |
| jackson-jaxrs-smile-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jaxrs-smile-provider/latest/overview) | N/A |
| jackson-jaxrs-xml-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jaxrs-xml-provider/latest/overview) | N/A |
| jackson-jaxrs-yaml-provider | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jaxrs-yaml-provider/latest/overview) | N/A |
| jackson-jr-all | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jr-all/latest/overview) | N/A |
| jackson-jr-annotation-support | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jr-annotation-support/latest/overview) | N/A |
| jackson-jr-extension-javatime | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jr-extension-javatime/latest/overview) | N/A |
| jackson-jr-objects | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jr-objects/latest/overview) | N/A |
| jackson-jr-retrofit2 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jr-retrofit2/latest/overview) | N/A |
| jackson-jr-stree | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-jr-stree/latest/overview) | N/A |
| jackson-module-afterburner | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-afterburner/latest/overview) | N/A |
| jackson-module-android-record | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-android-record/latest/overview) | N/A |
| jackson-module-blackbird | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-blackbird/latest/overview) | N/A |
| jackson-module-guice | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-guice/latest/overview) | N/A |
| jackson-module-guice7 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-guice7/latest/overview) | N/A |
| jackson-module-jakarta-xmlbind-annotations | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-jakarta-xmlbind-annotations/latest/overview) | N/A |
| jackson-module-jaxb-annotations | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-jaxb-annotations/latest/overview) | N/A |
| jackson-module-jsonSchema | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-jsonSchema/latest/overview) | N/A |
| jackson-module-jsonSchema-jakarta | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-jsonSchema-jakarta/latest/overview) | N/A |
| jackson-module-kotlin | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-kotlin/latest/overview) | N/A |
| jackson-module-mrbean | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-mrbean/latest/overview) | N/A |
| jackson-module-no-ctor-deser | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-no-ctor-deser/latest/overview) | N/A |
| jackson-module-osgi | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-osgi/latest/overview) | N/A |
| jackson-module-parameter-names | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-parameter-names/latest/overview) | N/A |
| jackson-module-paranamer | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-paranamer/latest/overview) | N/A |
| jackson-module-scala_2.11 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-scala_2.11/latest/overview) | N/A |
| jackson-module-scala_2.12 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-scala_2.12/latest/overview) | N/A |
| jackson-module-scala_2.13 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-scala_2.13/latest/overview) | N/A |
| jackson-module-scala_3 | Product | [2.18.3](https://cloud.google.com/java/docs/reference/jackson-module-scala_3/latest/overview) | N/A |
| javax.annotation-api | Product | [1.3.2](https://cloud.google.com/java/docs/reference/javax.annotation-api/latest/overview) | N/A |
| json | Product | [20250517](https://cloud.google.com/java/docs/reference/json/latest/overview) | N/A |
| jsr305 | Product | [3.0.2](https://cloud.google.com/java/docs/reference/jsr305/latest/overview) | N/A |
| junit-jupiter | Product | [5.11.4](https://cloud.google.com/java/docs/reference/junit-jupiter/latest/overview) | N/A |
| junit-jupiter-api | Product | [5.11.4](https://cloud.google.com/java/docs/reference/junit-jupiter-api/latest/overview) | N/A |
| junit-jupiter-engine | Product | [5.11.4](https://cloud.google.com/java/docs/reference/junit-jupiter-engine/latest/overview) | N/A |
| junit-jupiter-migrationsupport | Product | [5.11.4](https://cloud.google.com/java/docs/reference/junit-jupiter-migrationsupport/latest/overview) | N/A |
| junit-jupiter-params | Product | [5.11.4](https://cloud.google.com/java/docs/reference/junit-jupiter-params/latest/overview) | N/A |
| junit-platform-commons | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-commons/latest/overview) | N/A |
| junit-platform-console | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-console/latest/overview) | N/A |
| junit-platform-engine | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-engine/latest/overview) | N/A |
| junit-platform-jfr | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-jfr/latest/overview) | N/A |
| junit-platform-launcher | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-launcher/latest/overview) | N/A |
| junit-platform-reporting | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-reporting/latest/overview) | N/A |
| junit-platform-runner | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-runner/latest/overview) | N/A |
| junit-platform-suite | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-suite/latest/overview) | N/A |
| junit-platform-suite-api | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-suite-api/latest/overview) | N/A |
| junit-platform-suite-commons | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-suite-commons/latest/overview) | N/A |
| junit-platform-suite-engine | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-suite-engine/latest/overview) | N/A |
| junit-platform-testkit | Product | [1.11.4](https://cloud.google.com/java/docs/reference/junit-platform-testkit/latest/overview) | N/A |
| junit-vintage-engine | Product | [5.11.4](https://cloud.google.com/java/docs/reference/junit-vintage-engine/latest/overview) | N/A |
| nativeimage | Product | [25.0.0](https://cloud.google.com/java/docs/reference/nativeimage/latest/overview) | N/A |
| opencensus-api | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-api/latest/overview) | N/A |
| opencensus-contrib-grpc-util | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-contrib-grpc-util/latest/overview) | N/A |
| opencensus-contrib-http-util | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-contrib-http-util/latest/overview) | N/A |
| opencensus-contrib-resource-util | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-contrib-resource-util/latest/overview) | N/A |
| opencensus-contrib-zpages | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-contrib-zpages/latest/overview) | N/A |
| opencensus-exporter-stats-stackdriver | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-exporter-stats-stackdriver/latest/overview) | N/A |
| opencensus-exporter-trace-stackdriver | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-exporter-trace-stackdriver/latest/overview) | N/A |
| opencensus-impl | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-impl/latest/overview) | N/A |
| opencensus-impl-core | Product | [0.31.1](https://cloud.google.com/java/docs/reference/opencensus-impl-core/latest/overview) | N/A |
| opentelemetry-api | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-api/latest/overview) | N/A |
| opentelemetry-common | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-common/latest/overview) | N/A |
| opentelemetry-context | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-context/latest/overview) | N/A |
| opentelemetry-exporter-common | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-common/latest/overview) | N/A |
| opentelemetry-exporter-logging | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-logging/latest/overview) | N/A |
| opentelemetry-exporter-logging-otlp | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-logging-otlp/latest/overview) | N/A |
| opentelemetry-exporter-otlp | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-otlp/latest/overview) | N/A |
| opentelemetry-exporter-otlp-common | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-otlp-common/latest/overview) | N/A |
| opentelemetry-exporter-sender-grpc-managed-channel | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-sender-grpc-managed-channel/latest/overview) | N/A |
| opentelemetry-exporter-sender-jdk | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-sender-jdk/latest/overview) | N/A |
| opentelemetry-exporter-sender-okhttp | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-sender-okhttp/latest/overview) | N/A |
| opentelemetry-exporter-zipkin | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-exporter-zipkin/latest/overview) | N/A |
| opentelemetry-extension-kotlin | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-extension-kotlin/latest/overview) | N/A |
| opentelemetry-extension-trace-propagators | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-extension-trace-propagators/latest/overview) | N/A |
| opentelemetry-gcp-resources | Product | [1.45.0-alpha](https://cloud.google.com/java/docs/reference/opentelemetry-gcp-resources/latest/overview) | N/A |
| opentelemetry-grpc-1.6 | Product | [2.1.0-alpha](https://cloud.google.com/java/docs/reference/opentelemetry-grpc-1.6/latest/overview) | N/A |
| opentelemetry-opentracing-shim | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-opentracing-shim/latest/overview) | N/A |
| opentelemetry-sdk | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk/latest/overview) | N/A |
| opentelemetry-sdk-common | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-common/latest/overview) | N/A |
| opentelemetry-sdk-extension-autoconfigure | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-extension-autoconfigure/latest/overview) | N/A |
| opentelemetry-sdk-extension-autoconfigure-spi | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-extension-autoconfigure-spi/latest/overview) | N/A |
| opentelemetry-sdk-extension-jaeger-remote-sampler | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-extension-jaeger-remote-sampler/latest/overview) | N/A |
| opentelemetry-sdk-logs | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-logs/latest/overview) | N/A |
| opentelemetry-sdk-metrics | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-metrics/latest/overview) | N/A |
| opentelemetry-sdk-testing | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-testing/latest/overview) | N/A |
| opentelemetry-sdk-trace | Product | [1.57.0](https://cloud.google.com/java/docs/reference/opentelemetry-sdk-trace/latest/overview) | N/A |
| opentelemetry-semconv | Product | [1.29.0-alpha](https://cloud.google.com/java/docs/reference/opentelemetry-semconv/latest/overview) | N/A |
| opentelemetry-semconv | Product | [1.26.0-alpha](https://cloud.google.com/java/docs/reference/opentelemetry-semconv/latest/overview) | N/A |
| perfmark-api | Product | [0.27.0](https://cloud.google.com/java/docs/reference/perfmark-api/latest/overview) | N/A |
| shared-resourcemapping | Product | [0.33.0](https://cloud.google.com/java/docs/reference/shared-resourcemapping/latest/overview) | N/A |
| threeten-extra | Product | [1.8.0](https://cloud.google.com/java/docs/reference/threeten-extra/latest/overview) | N/A |
| threetenbp | Product | [1.7.0](https://cloud.google.com/java/docs/reference/threetenbp/latest/overview) | N/A |
| tink | Product | [1.16.0](https://cloud.google.com/java/docs/reference/tink/latest/overview) | N/A |
<!-- TABLE_END -->
