...
file_data_mapping = {
    'site/data/variableProductReferenceLinks.yaml': product_documentation_dict,
    'site/data/variableLibraryReferenceLinks.yaml': client_documentation_dict,
    'site/data/name_pretty.yaml': api_namepretty_dict
}
