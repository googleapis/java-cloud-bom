...
file_paths = ['libraries-bom-table-generation/helpers/repos_for_versionstxt.txt', 'libraries-bom-table-generation/helpers/handwritten_libraries_javadocs_modules.txt']
yaml_file = 'libraries-bom-table-generation/helpers/javaModulesVersions.yaml'
