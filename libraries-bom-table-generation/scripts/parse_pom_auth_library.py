...
with open(os.path.join('libraries-bom-table-generation/helpers/', 'javaModulesVersions.yaml'), 'a') as f:
...
output_file = "libraries-bom-table-generation/helpers//handwritten_libraries_javadocs_modules.txt"
